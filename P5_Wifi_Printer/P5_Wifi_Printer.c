...
int main() {
    ...
    addJob("Dr. Asokan", "CS101_Lecture.pdf", 25);
    addJob("Prof. Ajeesh", "TOC_Assignment.pdf", 15);
    addJob("Prof. Sreevidya", "PCCSL307_Lab_cycle.pdf", 40);
    addJob("Prof. Leena", "OOP_Notes.pdf", 30);
